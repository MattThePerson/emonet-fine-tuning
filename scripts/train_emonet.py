...
def main(args):
    ...
    # dataset paths
    train_csv =  args.dataset_path + os.sep + args.train_csv
    test_csv =   args.dataset_path + os.sep + args.test_csv
    train_root = args.dataset_path + os.sep + args.train_root
    test_root =  args.dataset_path + os.sep + args.test_root
